 ...
 *
 */
public class KalinkaPubBrokerFilter<K, V> extends BrokerFilter {

	private final MessagePublisherProvider<Message, K, V> messagePublisherProvider;
	private final KafkaTemplate<K, V> kafkaTemplate;

	private final Logger LOG = LoggerFactory.getLogger(KalinkaPubBrokerFilter.class);

	public KalinkaPubBrokerFilter(final Broker next, final MessagePublisherProvider<Message, K, V> messagePublisherProvider,
